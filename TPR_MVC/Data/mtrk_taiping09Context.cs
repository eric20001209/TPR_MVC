...
namespace TPR_MVC.Data
{
    public partial class mtrk_taiping09Context : DbContext
    {
        public mtrk_taiping09Context()
        {
        }

        public mtrk_taiping09Context(DbContextOptions<mtrk_taiping09Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
				optionsBuilder.UseSqlServer("Server=localhost;Database=mtrk_taiping09;Trusted_Connection=True;");
//				optionsBuilder.UseSqlServer(Startup.Configuration["sqlconnection"]);
			}
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Card>(entity =>
            {
                ...
                entity.HasIndex(e => e.DealerLevel)
                    .HasName("IDX_card_dealer_level");

                entity.HasIndex(e => e.Email)
                    .HasName("IDX_card_email")
                    .IsUnique();
                ...
                entity.HasIndex(e => e.Type)
                    .HasName("IDX_card_type");

                entity.Property(e => e.Id).HasColumnName("id");

                entity.Property(e => e.AcceptMassEmail)
                    .IsRequired()
                ...
                entity.Property(e => e.CatAccessGroup)
                ...
                entity.Property(e => e.NoSysQuote)
                    .IsRequired()
            ...
            modelBuilder.Entity<CodeRelations>(entity =>
            {
                ...
                entity.Property(e => e.IsBarcodeprice)
                ...
                entity.Property(e => e.IsVoidMemberDiscount).HasColumnName("is_void_member_discount");
